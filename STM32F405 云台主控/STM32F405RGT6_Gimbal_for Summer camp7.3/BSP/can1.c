...
int16_t encoder_202_RAW = 0;
int16_t encoder_203 = 0;
int16_t phaseZ_201 = 0;
int16_t phaseZ_202 = 0;
...
void CAN1_RX0_IRQHandler(void)
{
    ...
    if (CAN_GetITStatus(CAN1,CAN_IT_FMP0)!= RESET) 
	{
        ...
        {             
            ...
            phaseZ_201 = (rx_message.Data[2]<<8)|rx_message.Data[3];
            current_201 = (rx_message.Data[4]<<8)|rx_message.Data[5];
        ...
        { 
            encoder_202_RAW = (rx_message.Data[0]<<8)|rx_message.Data[1];
            phaseZ_202 = (rx_message.Data[2]<<8)|rx_message.Data[3];
            current_202 = (rx_message.Data[4]<<8)|rx_message.Data[5];
            if((encoder_202_RAW & 0x1000) == 0x1000)
            {
                encoder_202 = encoder_202_RAW - 8191;   //将202的值变为连续的正负数
            }
            else
            {
                encoder_202 = encoder_202_RAW;
            }
        ...
        { 
            ...
            {
                encoder_203 = encoder_203 - 8191;   //将203的值变为连续的正负数
            }
        }
    }
}
