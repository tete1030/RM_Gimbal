...
void Prepare_Data(void)
{
	...
	uint8_t i;
	ACC_X_BUF[filter_cnt] = MPU6050_Raw_Data.Accel_X;
	ACC_Y_BUF[filter_cnt] = MPU6050_Raw_Data.Accel_Y;
	ACC_Z_BUF[filter_cnt] = MPU6050_Raw_Data.Accel_Z;
	...
	GYRO_I.Z += MPU6050_Real_Data.Gyro_Z *0.002;
}
////////////////////////////////////////////////////////////////////////////////
#define Kp 0.75f                        // proportional gain governs rate of convergence to accelerometer/magnetometer
...
{
	IMUupdate(MPU6050_Real_Data.Gyro_X/57.324841,
						MPU6050_Real_Data.Gyro_Y/57.324841,
						MPU6050_Real_Data.Gyro_Z/57.324841,
