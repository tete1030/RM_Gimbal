...
#define CurrLimit 15000 //电流上限12000 for 6015//跟pid参数相关//6000for6025
uint16_t Can1_CNT = 0;
int16_t encoder_201 = 0;
int16_t encoder_202 = 0;
int16_t encoder_203 = 0;

int16_t current_201 = 0;
int16_t current_202 = 0;
int16_t current_203 = 0;

int16_t set_current_201 = 0;
int16_t set_current_202 = 0;
int16_t set_current_203 = 0;

int8_t hall_state_201 = 0;
int8_t hall_state_202 = 0;
int8_t hall_state_203 = 0;

int16_t CurrTemp_201[CurrTempNUM] = {0};
int16_t CurrTemp_202[CurrTempNUM] = {0};
int16_t CurrTemp_203[CurrTempNUM] = {0};

int16_t CurrCnt_201 = 0;
int16_t CurrCnt_202 = 0;
int16_t CurrCnt_203 = 0;

int32_t CurrInt_201 =0;
int32_t CurrInt_202 =0;
int32_t CurrInt_203 =0;

int16_t encoder_bias_201 = 0;
int16_t encoder_bias_202 = 0;
int16_t encoder_bias_203 = 0;

unsigned char OverCurr_flag = 0;
...
void CurrentProtect(void)
{
    ...
    if(Can1_CNT%20 == 0)
    {
        ...
        // 203电流保护
		CurrTemp_203[CurrCnt_203] = current_203;
		CurrCnt_203++;

		if(CurrCnt_203 >= CurrTempNUM){
			CurrCnt_203 = 0;
		}
		for(j = 0;j < CurrTempNUM;j++)
		{
			currtemp_203 += CurrTemp_203[j];
			CurrInt_203 = currtemp_203/CurrTempNUM;
		}
    }
        
    if((abs(CurrInt_201) > CurrLimit)||(abs(CurrInt_202) > CurrLimit)||(abs(CurrInt_203) > CurrLimit))
	{
		OverCurr_flag = 1;
	}
...
void CAN1_RX0_IRQHandler(void)
{
    ...
    if (CAN_GetITStatus(CAN1,CAN_IT_FMP0)!= RESET) 
	{
        ...
        {             
            encoder_201 = (rx_message.Data[0]<<8)|rx_message.Data[1];
            current_201 = (rx_message.Data[2]<<8)|rx_message.Data[3];
            set_current_201 = (rx_message.Data[4]<<8)|rx_message.Data[5];
            hall_state_201 = rx_message.Data[6];
            if((encoder_201 & 0x1000) == 0x1000)
            {
                //encoder_201 = encoder_201 - 8191;   //将201的值变为连续的正负数
            }
        ...
        { 
            encoder_202 = (rx_message.Data[0]<<8)|rx_message.Data[1];
            current_202 = (rx_message.Data[2]<<8)|rx_message.Data[3];
            set_current_202 = (rx_message.Data[4]<<8)|rx_message.Data[5];
            hall_state_202 = rx_message.Data[6];
            if((encoder_202 & 0x1000) == 0x1000)
            {
                //encoder_202 = encoder_202_RAW - 8191;   //将202的值变为连续的正负数
            }
        ...
        { 
            ...
            set_current_203 = (rx_message.Data[4]<<8)|rx_message.Data[5];
            hall_state_203 = rx_message.Data[6];
